...
struct SettingsView: View {
    ...
    @AppStorage("tripbudgetjar_showNotes") private var showNotes: Bool = true
    @AppStorage("tripbudgetjar_compactList") private var compactList: Bool = false
    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                Section("About") {
                    Link("Privacy Policy", destination: URL(string: "https://shimondeitel.github.io/tripjar-app/privacy.html")!)
                        .accessibilityIdentifier("settingsPrivacyLink")
                    Link("Terms of Use", destination: URL(string: "https://shimondeitel.github.io/tripjar-app/terms.html")!)
